			...
			if($_GET['action']=='order')
				{
					...
					{
						$save=$order->create_po($_POST['order_id'],$_POST['supplier_id'],$_POST['delivery_date'],$_POST['grace_period'],$_POST['order_date'],$_POST['order_po_nu']);
					...
					{
						$save=$order->edit_order($_POST['client_name'],$_POST['order_date'],$_POST['ship_date'],$_POST['pi_nu'],$_POST['pi_date'],$_POST['country'],$_POST['usd_inr'],$_POST['status'],$_POST['id']);
