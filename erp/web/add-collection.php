            ...
            <table class="table app-table-hover mb-0 text-left">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $viewall[$key]['collection_name'];?></td>
                  <td><img src="<?php echo $base_url.'theme/assets/images/'.$viewall[$key]['image'];?>" width="100"></td>
                  <td><i class="btn btn-danger fa fa-trash" onclick="deleteme('product','delete_collection','<?php echo $viewall[$key]['id'];?>')"></i></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
