		    ...
		    <div class="container-xl">
			    ...
			    <div class="row g-4 mb-4">
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total Store Item(s)</h4>
				...
				<div class="row g-4 mb-4">
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Total Creditor(s)</h4>
							    <div class="stats-figure"><?php $cc=$accounts->getall_beneficiery_sametype('1'); if($cc){echo COUNT($cc);}else{echo "0";} ?></div>
						    </div>
						    <a class="app-card-link-mask" href="#"></a>
					    </div>
				    </div>
				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title">Sale & Purchase</h4>
							        </div>
					        ...
					        <div class="app-card-body p-3 p-lg-4">
								...
								<?php $go=$order->get_sales_week(); 
								$go_id=array();
								$go_amt=array();
								$pgo_amt=array();
								foreach($go as $r=>$v)
								{
									array_push($go_id,$go[$r]['oid']);
									array_push($go_amt,$go[$r]['amount']);
								}
								$go_id_im = implode('","',$go_id);
								$go_amt_im = implode('","',$go_amt);

								$pgo=$order->get_po_week();
								foreach($pgo as $r=>$v)
								{
									array_push($pgo_amt,$pgo[$r]['amount']);
								}
								$pgo_amt_im = implode('","',$pgo_amt);
								?>
									<input type='hidden' value='["<?php echo $go_id_im;?>"]' id="order" />
									<input type='hidden' value='["<?php echo $go_amt_im;?>"]' id="sales_count" />
									<input type='hidden' value='["<?php echo $pgo_amt_im;?>"]' id="purchase_count" />
