<div class="app-wrapper">
  <div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
      <h1 class="app-page-title">Invoice</h1>
...
{echo "<div class='alert alert-danger'>Something went wrong, Please save invoice again</div>";}
...
if(COUNT((array)$po)>0){
    echo "<script>window.location.href='$base_url/index.php?action=dashboard&page=order-invoice-edit&id=$_GET[id]';</script>";
}
?>  
<h5 class="text-danger"><em><b>Note:-</b><em> To generate a Proforma Invoice, please fill all the details and click on Generate Invoice at the bottom right of the page. Before doing that please confirm all the pending quantity has been received from production.</h5>

<form name="generate_invoice" action="<?php echo $base_url.'index.php?action=order&query=generate_invoice';?>" method="post">
<!---hidden values------->
...
<tr>
    <td colspan="3">IRN</td>
    <td colspan="10"><input type="text" name="irn" value=""></td>
</tr>
<tr>
    <td colspan="3">AcK No.</td>
    <td colspan="10"><input type="text" name="ack_nu" value=""></td>
</tr>
<tr>
    <td colspan="3">Ack Date</td>
    <td colspan="10"><input type="date" name="ack_date" value=""></td>
</tr>
...
<td colspan="2">
<input type="text" name="commercial_invoice_nu" value="" >
</td>
<th>PAN</th>
...
<td colspan="2"><input type="date" name="commercial_invoice_date" value=""></td>
...
<td colspan="2"><input type="text" name="performa_invoice_nu" value="" ></td>
...
<td colspan="2"><input type="date" name="performa_invoice_date" value="" required></td>
...
<input type="text" name="eway_nu" value="">
</th>
</tr>
...
<td>LUT No.</th>
<td><input type="text" name="lutnu" value=""></td>
<th>LUT Date</th>
<td><input type="text" name="lut_date" value=""></td>
</tr>
...
<input type="text" name="batch_code" value="">
</th>
</tr>
...
<tbody>
    ...
    <tr>
        ...
        <td colspan="2"><input type="text" name="eseal_nu" value=""></td>
        <th colspan="2">Line Seal No.</th>
        <th colspan="2">Country of Origin of Goods</th>
        <th colspan="2">Country of Final Destination</th>
</tr>    
<tr>
        <th colspan="2"><input type="text" name="container_nu" value=""></th>
        <th colspan="2"><input type="text" name="vehical_nu" value=""></th>
        <th colspan="2">Date & Time</th>
        <td colspan="2"><input type="text" name="date_time_ship" value=""></td>
        <th colspan="2"><input type="text" name="line_nu" value=""></th>
...
<tr>
        ...
        <th>SB No.</th>
        <td colspan="2"><input type="text" name="sb_nu" value=""></td>
        <th colspan="2">Bill of Ladding Number</th>
        <th colspan="2">Port of Discharge</th>
        <th colspan="7">Terms of Delivery and Payment</th>
</tr>
<tr>
        <th colspan="2"><input type="text" name="pre_by" value=""></th>
        <th>SB Date</th>
        <td colspan="2"><input type="date" name="sb_date" value=""></td>
        <th colspan="2"><input type="text" name="bill_ladding_nu" value=""></th>
        <th colspan="2"><input type="text" name="port_discharge" value=""></th>
...
<tr>
        <th colspan="2"><input type="text" name="pre_carrier_place" value=""></th>
        <td colspan="3"><input type="text" name="port_loading" value=""></td>
        <th colspan="2"><input type="text" name="vessel_nu" value=""></th>
        <th colspan="2"></th>
...
$cartoon_final+=$cartoon*$order_products[$k]['qty'];
$pcs_final+=$pcs*$order_products[$k]['qty'];
?>
<tr>
...
<tfoot>
    ...
    <tr>
        ...
        <th><input type="text" name="trade_discount" id="trade_discount" value="0" onkeyup="auto_calc()" required></th>
    </tr>
    <tr>
        ...
        <th><input type="text" name="freight_charges" id="freight_charges" value="0" onkeyup="auto_calc()" required></th>
    </tr>
    <tr>
        <td colspan="3">Total Pcs</td>
        <th><?php echo $pcs_final;?></th>
        <td class="bg-danger" colspan="3">Add Other Charges (INR)</td>
        <th><input type="text" name="other_charges" id="other_charges" value="0" onkeyup="auto_calc()" required></th>
    </tr>
    <tr>
        <td colspan="3">Total Cartons</td>
        <th><?php echo $cartoon_final;?></th>
        <td class="bg-danger" colspan="3">Less Advance Payment (INR)</td>
        <th><input type="text" name="advance_payment" id="advance_payment" value="0" onkeyup="auto_calc()"></th>
    </tr>
    <tr>
        ...
        <b id='amt_inr'></b>
            ...
            <input type="hidden" name="total_usd" id="total_usd_read" value="" >
            <input type="hidden" name="total_inr" id="total_inr_read" value="" >
        </th>
    </tr>
    <tr>
...
<tr>
    ...
    <td colspan="2"><input type="submit" class="btn btn-success btn-md" name="submit" value="Generate Proforma Invoice"></td>
</tr>
</tfoot>
</table>
</form>
