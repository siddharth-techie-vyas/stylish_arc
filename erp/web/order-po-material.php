...
<h1 class="app-page-title">Product List(s) For Material</h1>
...
<div class="app-card alert alert-dismissible shadow-sm mb-4" role="alert">
    ...
    <thead>
      <tr >
        ...
        <td colspan="5" style="color:#FFF; background-color:#808080;">
    ...
    <tbody>
      ...
      <!-- table data will go here -->
       ...
       foreach($po_supplier_products as $k=>$value){
        ...
        //-- product details
        $pdetails=$product->getone_product_details($po_supplier_products[$k]['pid']); 
        //-- order price 
      ...
      <tr id="<?php echo $po_supplier_products[$k]['id'];?>">
        ...
        <td>            <input type="hidden" name="id[]" value="<?php echo $po_supplier_products[$k]['id'];?>"/>
        ...
        <td>
        <?php 
        echo "<b>".$pname[0]['sku_code']." / ".$pname[0]['buyer_code']."</b><br><small>".$pname[0]['product_name']."</small>";?>
        </td>
        ...
        if($pdetails)
        {
            foreach($pdetails as $pd=>$v1)
            {
                echo "<option value='".$pdetails[$pd]['material']."' ";
                if($pdetails[$pd]['material']==$po_supplier_products[$k]['remark']){echo "selected='selected'";}                
                echo  ">".$pdetails[$pd]['material']."</option>";
            }
        }
        else
        {
            echo "<option>No Material Found</option>";
        }
        ?>
        </select>    
        </td>
        ...
        <td><?php echo $order_detail[0]['qty'];?></td>
        ...
        for($i=0; $i<=$order_detail[0]['qty'];$i++){?>  
