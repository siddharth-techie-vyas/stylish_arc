                  ...
                  <div class="form-group row">
                         <div class="col-sm-6 col-md-3">
                          <input type="hidden" name="pid" value="<?php echo $_GET['id'];?>">
                            <label class="col-form-label">Material Name <span>*</span></label>
                            <input list="woods" name="material" class="form-control" required>
                        </div>

                         <div class="col-sm-6 col-md-3">
                         <label class="col-form-label">Length (<?php echo $default_size[0]['value1']; ?>) <span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="clength" id="clength2" onkeypress="cbm_auto('clength2','cwidth2','cheight2','ccbm2','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>

                         <div class="col-sm-6 col-md-3">
                         <label class="col-form-label">Width (<?php echo $default_size[0]['value1']; ?>)<span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="cwidth" id="cwidth2" onkeypress="cbm_auto('clength2','cwidth2','cheight2','ccbm2','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>

                         <div class="col-sm-6 col-md-3">
                         <label class="col-form-label">Height (<?php echo $default_size[0]['value1']; ?>)<span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="cheight" id="cheight2" onkeypress="cbm_auto('clength2','cwidth2','cheight2','ccbm2','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>
                  ...
                  <div class="form-group row">
                         <div class="col-sm-6 col-md-3">
                          <label class="col-form-label">CBM (M3)<span class="mendetory">*</span></label>
                           <input type="number" step=".001" value="0.0" class="form-control form-control-sm" name="cbm"  id="ccbm2" required>
                         </div>
  ...
  <table class="table table-bordered" style="font-size:13px;">
    <thead>
              ...
              <tbody>
                <?php
                $counterde=1;
                $details=$product->getone_product_details_nomaterial($_GET['id']);
