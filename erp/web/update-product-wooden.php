  ...
  <!-- row 1--->
                  <div class="form-group row">
                         ...
                         <label class="col-form-label">Length (<?php echo $default_size[0]['value1']; ?>) <span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="clength" id="clength1" onkeypress="cbm_auto('clength1','cwidth1','cheight1','ccbm1','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>

                         <div class="col-sm-6 col-md-3">
                         <label class="col-form-label">Width (<?php echo $default_size[0]['value1']; ?>)<span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="cwidth" id="cwidth1" onkeypress="cbm_auto('clength1','cwidth1','cheight1','ccbm1','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>

                         <div class="col-sm-6 col-md-3">
                         <label class="col-form-label">Height (<?php echo $default_size[0]['value1']; ?>)<span class="mendetory">*</span></label>
                           <input type="number" step=".01" value="0.0" class="form-control form-control-sm" name="cheight" id="cheight1" onkeypress="cbm_auto('clength1','cwidth1','cheight1','ccbm1','<?php echo $default_size[0]['value1']; ?>')"  required>
                         </div>
                  ...
                  <div class="form-group row">
                         <div class="col-sm-6 col-md-3">
                          <label class="col-form-label">CBM (M3)<span class="mendetory">*</span></label>
                           <input type="number" step=".001" value="0.0" class="form-control form-control-sm" name="cbm"  id="ccbm1" required>
                         </div>
  ...
  <table class="table table-bordered" style="font-size:13px;">
    <thead>
              ...
              <tbody>
                <?php
                $counterde=1;
                $details=$product->getone_product_details_bymaterial($_GET['id'],'wood');
