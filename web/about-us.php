...
<!-- .page-title -->
        <div class="page-title relative">
            <div class="paralaximg" data-parallax="scroll" data-image-src="<?php echo $base_url.'assets/images/'.$aboutus[0]['value1'];?>">
            </div>
            <div class="content">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="main-content">
                            ...
                            <div class="right">
                                ...
                                <p class="text_secondary text-body-1 wow fadeInUp" data-wow-delay="0.1s"><?php echo $aboutus[0]['value4'];?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <section class="flat-spacing-2 about-us">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="img-style ">
                            <img class="lazyload " src="<?php echo $base_url.'assets/images/aboutus2.jpg';?>" alt="img_box-about">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="box-about">
                            <div class="heading-section spacing-3">
                                ...
                                <p class="text-body-1 text_secondary wow fadeInUp" data-wow-delay="0.1s">Oriya products reflect the values of
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="team-item hover-img wow fadeInUp" data-wow-delay="0s">
                                        ...
                                        <div class="content">
                                            <div>
                                                <h5 class="name"><a class="link text-line-clamp-1" href="#">Pravesh Prajapat</a></h5>
                                                <div class="infor text-caption-1 text-secondary-2">Chief Prduction Office</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="team-item hover-img wow fadeInUp" data-wow-delay="0.1s">
                                        ...
                                        <div class="content">
                                            <div>
                                                <h5 class="name"><a class="link text-line-clamp-1" href="#">Ganesh Suthar</a></h5>
                                                <div class="infor text-caption-1 text-secondary-2">Chief Marketting
                                                    Officer</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="team-item hover-img wow fadeInUp" data-wow-delay="0.2s">
                                        ...
                                        <div class="content">
                                            <div>
                                                ...
                                                <div class="infor text-caption-1 text-secondary-2">Chief Technical Officer</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4">
                                <div class="footer-infor">
                                    <h6 class="footer-heading style-2  ">
                                        Store Details
                                    </h6>
                                    ...
                                    <div class="footer-col-block">
                                        ...
                                        <div class="tf-collapse-content">
                                            <ul class="footer-menu-list">
                                                ...
                                                <li class="text-body-default">
                                                    <a href="FAQs.html" class=" link footer-menu_item">Orders FAQs</a>
                                                </li>
                                                <li class="text-body-default">
                                ...
                                <div class="footer-col-block footer-newsletter">
                                    ...
                                    <div class="tf-collapse-content">
                                        <div class="wrap-newsletter">
                                            <p class="text-body-default">Sign up for our newsletter and get 10% off your
                                                first purchase</p>
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item active">
                        ...
                        <div id="dropdown-menu-five" class="collapse">
                            <ul class="sub-nav-menu">
                                <li><a href="about.html" class="sub-nav-link active">About Us</a></li>
            ...
            <div class="canvas-body">
                <div class="wd-facet-categories">
                    ...
                    <div id="forChair" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/product-1.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Chair</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/product-1.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Chair</span></a>
                            </li>
                ...
                <div class="wd-facet-categories">
                    ...
                    <div id="forDesk" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/popup-slidebar-item-2.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Desk</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/popup-slidebar-item-2.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Desk</span></a>
                            </li>
                ...
                <div class="wd-facet-categories">
                    ...
                    <div id="forPhone" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/product-5.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Phone</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/shop/product-5.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Phone</span></a>
                            </li>
                ...
                <div class="wd-facet-categories">
                    ...
                    <div id="forLamp" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/gallery/gallery-3.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Lamp</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/gallery/gallery-3.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Lamp</span></a>
                            </li>
                                ...
                                <div class="tf-mini-cart-bottom-wrap">
                                    ...
                                    <div class="tf-cart-checkbox">
                                        ...
                                        <label for="CartDrawer-Form_agree">
                                            I agree with
                                            <a href="term-of-use.html" class="link" title="Terms of Service">Terms &
                                                Conditions</a>
                                        </label>
                                    </div>
                                ...
                                <div class="tf-mini-cart-tool-content">
                                    ...
                                    <form class="form-add-note tf-mini-cart-tool-wrap">
                                        ...
                                        <div class="tf-cart-tool-btns">
                                            <button type="submit" class="tf-btn btn-onsurface w-full ">Save</button>
                                            <div
