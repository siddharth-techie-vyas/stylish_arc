                    ...
                    <li class="nav-mb-item active">
                        ...
                        <div id="dropdown-menu-one" class="collapse">
                            <ul class="sub-nav-menu">
                                <li><a href="index_3997808.html" class="sub-nav-link active">Homepage 01</a></li>
...
s1.async=true;
s1.src='https://embed.tawk.to/67e11928882a7519065312f2/1in3kki6p';
s1.charset='UTF-8';
...
<script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/lazysize.min.js"></script>
    <script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/wow.min.js"></script>
    <script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/multiple-modal.js"></script>
    <script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/parallax.min.js"></script>
    <script type="text/javascript" src="<?php echo $base_url.'assets/';?>js/simpleParallaxVanilla.umd_1245220.js"></script>
